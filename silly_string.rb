...
# Challenge 2: Capitalize every letter in your_favorite_word using a built in Ruby methodruby
...
sentence = sentence.gsub("A", "O").gsub("a", "o"); sentence # Add your gsub chain here
